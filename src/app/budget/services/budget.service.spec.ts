...
beforeEach(() => {
    ...
    snapshotChangesSpy = jasmine.createSpy('snapshotChanges').and.returnValue(Observable.of(array1));

    stateChangesSpy = jasmine.createSpy('stateChangesSpy').and.returnValue(Observable.of([array2]));
...
describe('BudgetService', () => {
    it('#queryAllBudgets should return stubbed value from a spy', () => {
        const query$: Observable<DocumentChangeAction[]> = budgetService.queryAllBudgets('user001');
    ...
    it('#queryAllBudgetLines should return stubbed value from a spy', () => {
        const query$: Observable<DocumentChangeAction[]> = budgetService.queryAllBudgetLines('b001');
    ...
    it('#queryAllExpenses should return stubbed value from a spy', () => {
        const query$: Observable<DocumentChangeAction[]> = budgetService.queryAllExpenses('b001', 'bl001');
    ...
    it('#addExpense should return stubbed value from a spy', () => {
        ...
        const add$: Observable<void> = budgetService.addExpense(myExpense, 'b001', 'bl001');
    ...
    it('#deleteExpense should return stubbed value from a spy', () => {
        const delete$: Observable<void> = budgetService.deleteExpense('exp001', 'bl001', 'b001');
        expect(docSpy).toHaveBeenCalledTimes(1);
    ...
    it('#updateBudget should return stubbed value from a spy', () => {
        ...
        const update$: Observable<void> = budgetService.updateBudget('b001', budgetChanges);
        expect(docSpy).toHaveBeenCalledTimes(1);
