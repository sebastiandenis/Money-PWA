...
export const getBudgetModuleState = createFeatureSelector<State>(
  "budgetModule"
);
export const getBudgetsState = createFeatureSelector<fromBudget.State>(
  "budgets"
);
export const getBudgetLinesState = createFeatureSelector<fromBudgetLine.State>(
  "budgetLines"
);
export const getExpensesState = createFeatureSelector<fromExpense.State>(
  "expenses"
);
export const getShiftsState = createFeatureSelector<fromShift.State>("shifts");

export const selectBudgetsState = createSelector(
  getBudgetModuleState,
  getBudgetsState
);
export const selectBudgetLinesState = createSelector(
  getBudgetModuleState,
  getBudgetLinesState
);
...
export const selectBudgetIds = createSelector(
  selectBudgetsState,
  fromBudget.selectBudgetIds
);
export const selectBudgetLineIds = createSelector(
  selectBudgetLinesState,
  fromBudgetLine.selectBudgetLineIds
);
export const selectExpenseIds = createSelector(
  selectExpensesState,
  fromExpense.selectExpenseIds
);
export const selectShiftIds = createSelector(
  selectShiftsState,
  fromShift.selectShiftIds
);

// select the dictionary of entities
export const selectBudgets = createSelector(
  selectBudgetsState,
  fromBudget.selectBudgetEntities
);
export const selectBudgetLines = createSelector(
  selectBudgetLinesState,
  fromBudgetLine.selectBudgetLineEntities
);
export const selectExpenses = createSelector(
  selectExpensesState,
  fromExpense.selectExpenseEntities
);
export const selectShifts = createSelector(
  selectShiftsState,
  fromShift.selectShiftEntities
);

// select the array of entities
export const selectAllBudgets = createSelector(
  selectBudgetsState,
  fromBudget.selectAllBudgets
);
export const selectAllBudgetLines = createSelector(
  selectBudgetLinesState,
  fromBudgetLine.selectAllBudgetLines
);
export const selectAllExpenses = createSelector(
  selectExpensesState,
  fromExpense.selectAllExpenses
);
export const selectAllShifts = createSelector(
  selectShiftsState,
  fromShift.selectAllShifts
);

// select the total entities count
export const selectBudgetTotal = createSelector(
  selectBudgetsState,
  fromBudget.selectBudgetTotal
);
export const selectBudgetLineTotal = createSelector(
  selectBudgetLinesState,
  fromBudgetLine.selectBudgetLinesTotal
);
export const selectExpenseTotal = createSelector(
  selectExpensesState,
  fromExpense.selectExpenseTotal
);
export const selectShiftTotal = createSelector(
  selectShiftsState,
  fromShift.selectShiftTotal
);

// select selected entity id
export const selectCurrentBudgetId = createSelector(
  selectBudgetsState,
  fromBudget.getCurrentBudgetId
);
export const selectCurrentBudgetLineId = createSelector(
  selectBudgetLinesState,
  fromBudgetLine.getSelectedBudgetLineId
);
export const selectCurrentExpenseId = createSelector(
  selectExpensesState,
  fromExpense.getSelectedExpenseId
);
export const selectCurrentShiftId = createSelector(
  selectShiftsState,
  fromShift.getSelectedShiftId
);
